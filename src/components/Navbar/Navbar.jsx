...
const Navbar = () => {
  ...
  return (
    <div role="nav" className="navbar">
      <div className='navbar_logo'>
        <Link to='/'>
          <span className="not-themed">get</span><span className='themed'>linked</span>
        </Link>
      </div>
      <div className={`navbar_links ${menu && 'active'}`}>
        <div className={`cancel ${menu && 'active'}`} onClick={() => setMenu(false)}></div>
        <ul className={`navbar_links-container ${menu && 'active'}`}>
          <li>
          ...
          <li>
            <Link to='/contact' className="themed-gradient">
              Contact
            </Link>
          </li>
        </ul>
        <Link to='/register' className={`${menu && 'active'}`}>
          <button>
            Register
          </button>
        </Link>
      </div>
      <button className={`navbar_mobile`} onClick={() => setMenu(true)}>
